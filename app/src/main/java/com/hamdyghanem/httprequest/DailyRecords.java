...
public class DailyRecords extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        day = intent.getStringExtra(WeeklyList.EXTRA_MESSAGE);
        getChartInfo();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_daily_records, menu);
        return true;
    }
    ...
    public void getChartInfo(){
        try {
            ...
            String url = "http://webserviceanaliz.comyr.com/dayInfo.php?Day=" + day;
